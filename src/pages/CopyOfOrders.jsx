...
const FabricCalculator = () => {
  ...
  // add fabric number and get style numbers
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {results.length > 0 && (
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4 mb-4 md:mb-6">
            ...
            <div className="bg-white rounded-lg p-3 md:p-4 border border-gray-200">
              <p className="text-xs text-gray-500">Inventory Found Orders</p>
              <p className="text-lg md:text-xl font-bold text-blue-600">{inventoryFound}</p>
            </div>
